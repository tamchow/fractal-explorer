...
public class IFSCommonOptionsPanel extends JPanel {
	...
	/** DOCUMENT ME! */
	protected JComboBox numberOfPointsComboBox = new JComboBox(new String[] { "1", "2", "5", "10", "15", "20", "30", "40", "50", "100",
			"200" });
	/** DOCUMENT ME! */
	...
	public IFSCommonOptionsPanel() {
		...
		this.add(drawingMethodPanel, new GridBagConstraints(0, 0, 2, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
		this.add(ifsFractalComboBox, new GridBagConstraints(0, 1, 2, 1, 0.8, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
