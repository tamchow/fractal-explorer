...
/**
 * Polynomial formula calculating expression <code>Z<sup>4</sup> + Z<sup>3</sup> + Z<sup>3</sup> + Z<sup>2</sup> + Z + C</code>
 * @author Wojciech Antosiewicz
 */
public class Z_4_pls_Z_3_pls_Z_2_pls_Z extends PolynomialFormula {
	/**
	 * Creates formula with specified properties
	 * @param properties to use by this formula
	 */
	public Z_4_pls_Z_3_pls_Z_2_pls_Z(FormulaProperties properties){
		super(properties, 4);
	}
	...
	public final Complex calculate(Complex z){
		...
		return Complex.valueOf(
				(((re2 - (3 * im2)) * (re2 + z.getReal())) - (im2 * ((3 * re2) - im2)) + re2) - 
