...
/**
    ...
    public IFSAnimationOptionsPanel() {
        ...
        addFractalButton.addActionListener(
        ...
        removeFractalButton.addActionListener(
            new java.awt.event.ActionListener() {
                public void actionPerformed(ActionEvent e) {
        ...
        this.add(
            jScrollPane2,
            new GridBagConstraints(
                0, 3, 2, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 5, 5, 5), 0, 0));
        this.add(
            addFractalButton,
            new GridBagConstraints(
                0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(3, 20, 3, 5), 0, 0));
        this.add(
            removeFractalButton,
            new GridBagConstraints(
        ...
        if (dlm.isEmpty()) {
            ...
            if (przek != selFractal.getTransformCount()) {
                JOptionPane.showMessageDialog(
                    this, "Selected fractal has different number of transforms\nthan fractals selected earlier.",
            ...
            if (dlm.contains(selFractal)) {
                if (
                    JOptionPane.showConfirmDialog(
                            this, "Selected fractal is already in the lis.\nAdd it again?",
