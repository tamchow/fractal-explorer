...
public class IFSDrawingOptionsPanel extends IFSCommonOptionsPanel {
    ...
    public IFSDrawingOptionsPanel() {
        ...
        this.add(drawButton,
        		new GridBagConstraints(
                0, 5, 1, 1, 1.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 20, 0, 10),
                0, 0));
        ...
        this.add(stopButton,
        		new GridBagConstraints(
                1, 5, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 10, 0, 10),
                0, 0));
    }
