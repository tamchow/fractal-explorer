...
/**
    ...
    private void createFormulas() {
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-2.2, 1.0, -1.6, 1.6), 2) {
                public final Complex calculate(Complex z) {
                    ...
                    Complex egh = Complex.valueOf(
                            re2 - im2 + this.constant.getReal(),
                            (z.getReal() * z.getImaginary() * 2) + constant.getImaginary());
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-3.0, 0.8, -1.5, 1.5), 2) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.5, 1.5, -1.5, 1.5), 3) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-2.5, 1.5, -1.5, 1.5), 3) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();

                    return Complex.valueOf(
                        ((z.getReal() * (re2 - (3 * im2))) + re2) - im2 + constant.getReal(),
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-2.0, 1.5, -1.6, 1.6), 3) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();

                    return Complex.valueOf(
                        ((z.getReal() * (re2 - (3 * im2))) + re2) - im2 + z.getReal() + constant.getReal(),
                        (z.getImaginary() * ((3 * re2) - im2)) + (2 * z.getReal() * z.getImaginary())
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.7, 1.2, -1.5, 1.5), 4) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.8, 1.1, -1.5, 1.5), 4) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();

                    return Complex.valueOf(
                        ((re2 - (3 * im2)) * (re2 + z.getReal())) - (im2 * ((3 * re2) - im2)) + constant.getReal(),
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.5, 0.9, -1.5, 1.5), 4) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.7, 0.8, -1.5, 1.5), 4) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.5, 1.5, -1.5, 1.5), 5) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.5, 1.0, -1.25, 1.25), 5) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.5, 1.5, -1.5, 1.5), 6) {
                public final Complex calculate(Complex z) {
                    double re2 = z.getReal() * z.getReal();
                    double im2 = z.getImaginary() * z.getImaginary();
        ...
        // ##############################################################################
        formulas.add(
            new PolynomialFormula(new FormulaProperties(-1.5, 1.5, -1.5, 1.5), 8) {
                public final Complex calculate(Complex z) {
                    double a;
                    double b;
                    double c;
