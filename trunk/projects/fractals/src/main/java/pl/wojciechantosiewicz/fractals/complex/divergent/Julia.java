...
public class Julia extends DivergentFractal {
	...
	public Julia() {
		...
		points = new Complex[] { Complex.valueOf(-1.52, 0.0), Complex.valueOf(-1.503, 0.031), Complex.valueOf(-1.43, 0.064),
				...
				Complex.valueOf(0.125, 0.971), Complex.valueOf(0.240, 0.856), Complex.valueOf(0.356, 0.874), Complex.valueOf(0.432, 0.868),
		...
		points = new Complex[] { Complex.valueOf(-1.236, 0.0), Complex.valueOf(-1.103, -0.015), Complex.valueOf(-1.054, 0.081),
				...
				Complex.valueOf(-0.017, 0.95), Complex.valueOf(0.056, 1.045), Complex.valueOf(-0.02, 1.187), Complex.valueOf(0.082, 0.916),
		...
		points = new Complex[] { Complex.valueOf(-1.1, 4.28e-4), Complex.valueOf(-1.062, 0.015), Complex.valueOf(-1.055, 0.04),
				...
				Complex.valueOf(-0.789, 0.170), Complex.valueOf(-0.856, 0.191), Complex.valueOf(-0.759, 0.212),
				Complex.valueOf(-0.698, 0.29), Complex.valueOf(-0.671, 0.372), Complex.valueOf(-0.588, 0.627),
