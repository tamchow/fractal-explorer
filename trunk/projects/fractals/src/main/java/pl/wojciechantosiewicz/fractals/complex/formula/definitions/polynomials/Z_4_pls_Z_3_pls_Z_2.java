...
/**
 * Polynomial formula calculating expression <code>Z<sup>4</sup> + Z<sup>3</sup> + Z<sup>3</sup> + Z<sup>2</sup> + C</code>
 * @author Wojciech Antosiewicz
 */
public class Z_4_pls_Z_3_pls_Z_2 extends PolynomialFormula {
	/**
	 * Creates formula with specified properties
	 * @param properties to use by this formula
	 */
	public Z_4_pls_Z_3_pls_Z_2(FormulaProperties properties){
		super(properties, 4);
	}
