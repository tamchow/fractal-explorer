...
/**
 * Polynomial formula calculating expression <code>Z<sup>3</sup> + Z<sup>2</sup> + Z + C</code>
 * @author Wojciech Antosiewicz
 */
public class Z_3_pls_Z_2_pls_Z extends PolynomialFormula {
	/**
	 * Creates formula with specified properties
	 * @param properties to use by this formula
	 */
	public Z_3_pls_Z_2_pls_Z(FormulaProperties properties){
		super(properties, 3);
	}
